...
public:
	...
	std::vector<PetsInfo> pets{
		...
		{ "PetBubbleTeaBear",		"BubbleTeaBear",			std::make_pair(1, 4)},
		{ "PetBuglet",				"Flutterbug",				std::make_pair(1, 22)},
		{ "PetBunny",				"Bun Bun",					std::make_pair(1, 48)},
		{ "PetCapybara",			"Capybara",					std::make_pair(1, 4)},
		...
		{ "PetChibiAnnie",			"Chibi Annie",				std::make_pair(1, 4)},
		{ "PetChibiAshe",			"Chibi Ashe",				std::make_pair(1, 4)},
		{ "PetChibiBlitzcrank",		"Chibi Blitzcrank",			std::make_pair(1, 3)},
		{ "PetChibiBriar",			"Chibi Briar",				std::make_pair(1, 3)},
		{ "PetChibiCaitlyn",		"Chibi Caitlyn",			std::make_pair(1, 3)},
		...
		{ "PetChibiJinx",			"Chibi Jinx",				std::make_pair(1, 3)},
		{ "PetChibiKaisa",			"Chibi Kai'Sa",				std::make_pair(1, 3)},
		{ "PetChibiKatarina",		"Chibi Katarina",			std::make_pair(1, 3)},
		...
		{ "PetElderDragon",			"Dragon",					std::make_pair(1, 4)},
		...
		{ "PetLamb",				"Lamb",						std::make_pair(1, 4)},
		...
		{ "PetMinion",				"Minion",					std::make_pair(1, 6)},
		{ "PetNebulaFox",			"NebulaFox",				std::make_pair(1, 4)},
		...
		{ "PetSpaceCat",	        "SpaceCat",					std::make_pair(1, 4)},
		{ "PetSpongeFish",	        "SpongeFish",		        std::make_pair(1, 2)},
		...
		{ "PetStyleTwoIrelia",		"Mythmaker Irelia Unbound",	std::make_pair(2, 2)},
		{ "PetStyleTwoJhin",		"Dark Cosmic Jhin Unbound",	std::make_pair(1, 2)},
		{ "PetStyleTwoJinx",		"Arcane Jinx Unbound",		std::make_pair(3, 3)},
		{ "PetStyleTwoLeesin",		"God Fist Lee Sin Unbound",	std::make_pair(2, 2)},
		{ "PetStyleTwoLucian",		"God Fist Lucian Unbound",	std::make_pair(2, 2)},
		{ "PetStyleTwoMordekaiser",	"Mordekaiser Unbound",		std::make_pair(2, 2)},
		...
		{ "PetStyleTwoVayne",		"Vayne Unbound",			std::make_pair(1, 1)},
		...
		{ "PetStyleTwoWarwick",		"Project Warwick Unbound",	std::make_pair(3, 3)},
